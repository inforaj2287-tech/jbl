document.addEventListener('DOMContentLoaded', function () {
  ...
  var meterHeading = document.getElementById('meterHeading');
  var HEADINGS = { local: 'Local Area Cabs', outstation: 'Outstation Cabs', package: 'Package Cabs' };
  tabs.forEach(function (btn) {
    btn.addEventListener('click', function () {
      tabs.forEach(function (b) { b.classList.remove('active'); });
      btn.classList.add('active');
      tripType.value = btn.dataset.tab;
      if (meterHeading) meterHeading.textContent = HEADINGS[btn.dataset.tab] || 'Cabs';
    });
  });
